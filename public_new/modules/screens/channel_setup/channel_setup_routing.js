/**
 * =========================================================================================
 * SCREEN CONTROLLER: Channel Setup - Routing & Patch Tab (channel_setup_routing.js)
 * =========================================================================================
 * Responsabilidade:
 * - Controlador da aba de Roteamento, Patch, Panpot e Pareamento (PAIR) na Central de Edição.
 * - Gerencia envio para os barramentos BUS 1-8, Direct Out e saída Master STEREO L/R.
 * - Orquestra a seleção matricial de Patch de Entrada (AD, Slot, Adat, FX, 2TR) e pareamento estéreo.
 *
 * Plano de Transição (Fase 7):
 * - Este controlador passará a alimentar o componente visual puro `modules/components/routing.js`,
 *   desacoplando a matriz de botões de barramentos e patches da lógica de estado global.
 * =========================================================================================
 */
