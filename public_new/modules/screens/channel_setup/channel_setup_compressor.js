/**
 * =========================================================================================
 * SCREEN CONTROLLER: Channel Setup - Compressor Panel (channel_setup_compressor.js)
 * =========================================================================================
 * Responsabilidade:
 * - Controlador do painel de Compressor dentro da aba de Dinâmica na Central de Edição do Canal.
 * - Gerencia sincronização dos parâmetros de Threshold, Ratio, Attack, Release, OutGain e Knee
 *   via WebSocket para todos os canais suportados da Yamaha 01V96 (Inputs, Auxs, Buses, Stereo Master).
 *
 * Plano de Transição (Fase 7):
 * - Este controlador passará a alimentar o componente visual puro `modules/components/compressor.js`,
        ...
        <div class="dyn-meter-container">
            <div class="dyn-meter-wrapper" style="position: relative; margin-bottom: 8px;">
                <div class="dyn-meter-track-gr">
                    <div class="dyn-meter-fill-gr" id="compGrMeter"></div>
                </div>
