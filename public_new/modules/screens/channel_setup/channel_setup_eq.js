/**
 * =========================================================================================
 * SCREEN CONTROLLER: Channel Setup - Equalizer Tab (channel_setup_eq.js)
 * =========================================================================================
 * Responsabilidade:
 * - Controlador de tela da aba de Equalização dentro da Central de Edição do Canal.
 * - Gerencia o canal ativo (`activeConfigChannel`), sincroniza parâmetros via WebSocket com a mesa,
 *   e orquestra as interações e modais contextuais de EQ (ATT, RTA, modos de filtro, etc.).
 *
 * Plano de Transição (Fase 7):
 * - Este controlador passará a consumir o widget visual puro `modules/components/eq.js`,
 *   delegando toda a física de desenho de curvas Biquad e manipuladores de nós para o componente.
 * =========================================================================================
 */
        ...
        <div class="eq-container">
            <div class="eq-header">
                <div class="eq-header-row">
                    ...
                    <button id="headerBtnPaste" class="btn-state eq-header-btn ${window.contextClipboard && (window.contextClipboard.type === 'eq' || window.contextClipboard.type === 'full_channel') && (typeof window.contextClipboard.validateTarget === 'function' ? window.contextClipboard.validateTarget() : false) ? 'eq-header-btn-paste-on' : 'eq-header-btn-paste-off'}" ${window.contextClipboard && (window.contextClipboard.type === 'eq' || window.contextClipboard.type === 'full_channel') && (typeof window.contextClipboard.validateTarget === 'function' ? window.contextClipboard.validateTarget() : false) ? '' : 'disabled'} onclick="pasteClipboard(${ch})">COLAR</button>
