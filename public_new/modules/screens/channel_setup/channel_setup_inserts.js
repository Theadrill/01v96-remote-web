/**
 * =========================================================================================
 * SCREEN CONTROLLER: Channel Setup - Inserts Modal Controller (channel_setup_inserts.js)
 * =========================================================================================
 * Responsabilidade:
 * - Controlador do modal de configuração de Inserts do canal ativo na Central de Edição.
 * - Gerencia o estado de Insert On/Off, seleção de posição (PRE EQ, PRE FADER, POST FADER),
 *   e roteamento de Patch de Saída (Omni, Adat, Slot, FX, 2TR) e Entrada (AD, Slot, Adat, FX).
 *
 * Plano de Transição (Fase 7):
 * - Este controlador passará a alimentar o componente visual puro `modules/components/inserts.js`,
 *   repassando tabelas de patch resolvidas e tratando ações de seleção via callbacks.
 * =========================================================================================
 */
