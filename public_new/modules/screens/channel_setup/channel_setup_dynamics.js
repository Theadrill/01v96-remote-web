/**
 * =========================================================================================
 * SCREEN CONTROLLER: Channel Setup - Dynamics Tab Coordinator (channel_setup_dynamics.js)
 * =========================================================================================
 * Responsabilidade:
 * - Controlador de tela da aba de Dinâmica (DYN) dentro da Central de Edição do Canal.
 * - Orquestra a renderização combinada dos painéis de Gate e Compressor para o canal ativo.
 * - Gerencia o ciclo de vida do polling de Ganho de Redução (GR) e nudges de parâmetros.
 *
 * Plano de Transição (Fase 7):
 * - Este controlador passará a consumir o widget integrador `modules/components/dynamics.js`,
 *   que por sua vez encapsula os componentes visuais puros de Gate e Compressor.
 * =========================================================================================
 */
