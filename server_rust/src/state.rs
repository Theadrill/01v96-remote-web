...
impl GlobalState {
    pub fn new() -> Self {
        ...
        for i in 0..40 {
            channels.insert(i, ChannelState {
                value: 0.0,
                on: false,
                solo: false,
                phase: 0.0,
                ...
                name: format!("CH {}", i + 1),
                gate: GateState { on: false, thresh: -260.0, range: -60.0, attack: 0.0, hold: 20.0, decay: 50.0 },
                comp: CompState { on: false, thresh: -80.0, ratio: 7.0, attack: 30.0, release: 250.0, gain: 0.0, knee: 2.0 },
                buses: vec![false; 8],
                stereo: true,
                eq: EqState {
                    on: false,
                    mode: 0.0,
                    low: EqBand { f: 32.0, g: 0.0, q: 20.0, hpf_on: Some(0.0), lpf_on: None },
                    lowmid: EqBand { f: 60.0, g: 0.0, q: 20.0, hpf_on: None, lpf_on: None },
                    himid: EqBand { f: 84.0, g: 0.0, q: 20.0, hpf_on: None, lpf_on: None },
                    high: EqBand { f: 108.0, g: 0.0, q: 20.0, hpf_on: None, lpf_on: Some(0.0) },
                },
                paired: false,
                paired_with: None,
                pair_source: None,
