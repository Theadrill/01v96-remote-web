...
function createChannelStrip(i) {
    return `
        <div class="fader-card" onclick="openChannelConfig(event, ${i})" style="cursor: pointer;">
            ...
            <button id="solo${i}" class="btn-state" onclick="toggleState('kSetupSoloChOn/kSoloChOn', ${i})">Solo</button>
            <button id="on${i}" class="btn-state" onclick="toggleState('kInputChannelOn/kChannelOn', ${i})">On</button>
