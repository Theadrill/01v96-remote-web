...
1. `getChannelStateById()` - 59 edges
...
- `Channel Pair implementation plan` --conceptually_related_to--> `CHANNEL property category`  [INFERRED]
  docs/channel_pair_implementation_plan.md → reverse_dll_project/categorized_properties.json
...
Cohesion: 0.10
Nodes (22): ChannelLike, FxSyncAck, SceneManager, HashMap, Option, ParsedMidi, Self, String (+14 more)
...
Cohesion: 0.05
Nodes (37): Self, Vec, Instant, MidiEngine, MidiOutput, test_engine_initialization(), MidiAssembler, MidiEngine (+29 more)
...
Cohesion: 0.07
Nodes (82): Any, int, _ensure_gh_authenticated(), fetch_all(), get_current_pr_ref(), gh_api_graphql(), gh_pr_view_json(), main() (+74 more)
...
Cohesion: 0.05
Nodes (40): boot_delay_ms, demo_mode, disable_systray, dmx_boot_delay_ms, eq_flat_skip_hpf_lpf, inIdx, loopmidi-monitor, lumikit_ips (+32 more)
...
Cohesion: 0.11
Nodes (19): applyMetersToDOM(), applyServerNameToSidebar(), applySetupStatus(), buildMeterCache(), clearAllMeters(), isMobileAgent, lastPeakTime, lastWasmRenderTime (+11 more)
...
Cohesion: 0.21
Nodes (15): get_physical_short(), push_req(), queue_all_params_inner(), SyncManager, Arc, AtomicBool, CustomSceneManager, GlobalState (+7 more)
...
Cohesion: 0.12
Nodes (22): GlobalState, HashMap, PathBuf, Self, String, Value, Vec, AppConfig (+14 more)

### Community 104 - "Community 104"
Cohesion: 0.22
Nodes (23): build_change(), build_fx_input_change(), build_fx_input_request(), build_fx_output_change(), build_fx_output_request(), build_fx_type_request(), build_name_change(), build_name_request() (+15 more)
...
Cohesion: 0.11
Nodes (29): ChannelId, ChannelNameEntry, CustomSceneManager, RtaManager, AppConfig, Arc, ChannelId, ChannelNameEntry (+21 more)
...
Cohesion: 0.16
Nodes (16): clearMacroSelection(), getMacroFaderHtml(), macroDeltaToDB(), macroFader, nudgeMacro(), openMacroConfig(), renderMacroFader(), renderMacroGrid() (+8 more)

### Community 109 - "Community 109"
Cohesion: 0.21
Nodes (19): Arc, ChannelId, ChannelNameEntry, CustomSceneManager, GlobalState, HashMap, Option, RwLock (+11 more)
...
Cohesion: 0.26
Nodes (12): MasterMeter, Arc, ConnectionManager, CustomSceneManager, GlobalState, MidiScheduler, Receiver, RwLock (+4 more)
...
Cohesion: 0.09
Nodes (60): float32x4_t, KissCpx, KissFftState, Option, Self, Vec, Option, Self (+52 more)
...
Cohesion: 0.21
Nodes (12): Body, Next, Request, Response, Box, Error, Receiver, Result (+4 more)
...
Cohesion: 0.25
Nodes (7): files, main, name, sideEffects, type, types, version
...
Cohesion: 0.15
Nodes (14): Arc, HashMap, Result, Self, String, Vec, Fft, Float32Array (+6 more)
...
Cohesion: 0.53
Nodes (5): Arc, GlobalState, RwLock, SocketIo, setup_tailscale_serve()
...
Cohesion: 0.09
Nodes (36): CeltMode, Default, Option, RangeCoder, Self, Vec, alloc_trim_analysis(), AnalysisInfo (+28 more)
...
Cohesion: 0.17
Nodes (19): File, PathBuf, Self, main(), String, Vec, build_output_patch_request(), decode_value() (+11 more)
...
Cohesion: 0.12
Nodes (32): SilkEncoderControl, SilkEncoderState, Default, Self, silk_ana_filt_bank_1(), silk_biquad_alt_stride1(), silk_biquad_alt_stride2(), silk_lpc_fit() (+24 more)
...
Cohesion: 0.12
Nodes (32): Option, autocorr(), celt_fir(), celt_fir_neon(), celt_iir(), celt_iir_neon(), lpc(), celt_fir5() (+24 more)
...
Cohesion: 0.13
Nodes (15): OpusEncoder, Arc, Instant, Mutex, Option, Self, Sender, SocketIo (+7 more)
...
Cohesion: 0.17
Nodes (15): Default, Option, Self, SilkNSQState, Vec, NLSFCodebook, SideInfoIndices, SilkEncoderControl (+7 more)
...
Cohesion: 0.22
Nodes (9): Default, NLSFCodebook, Option, Self, SideInfoIndices, SilkCNGState, SilkDecoderControl, SilkDecoderState (+1 more)
...
Cohesion: 0.50
Nodes (4): 10, config, name, scriptId
...
- **Why does `kStereoEQ/kEQLowF` connect `Community 612` to `Architecture Refactor Plan`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `kStereoEQ/kEQLowG` connect `Community 612` to `Architecture Refactor Plan`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Are the 43 inferred relationships involving `getChannelStateById()` (e.g. with `execute()` and `auxWheelInput()`) actually correct?**
  _`getChannelStateById()` has 43 INFERRED edges - model-reasoned connections that need verification._
