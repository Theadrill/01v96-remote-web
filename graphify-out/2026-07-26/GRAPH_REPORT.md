...
## Corpus Check
- 617 files · ~12,503,758 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14108 nodes · 9959 edges · 7836 communities (967 shown, 6869 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 579 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ada5cf7`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- Mixer UI Client Modules (channel strip, EQ, gate, aux, routing)
- Community 1
- Migration Audit (Rust/Node.js Dead Code)
- Server Rust Core (boot, config, DMX, MIDI, state)
- CLI Tools & MIDI Bridge Utils
- MIDI Engine & Protocol (server_rust)
- Graphify Knowledge Graph Tool
- Reverse DLL Categorized Properties
- Macros Engine & Host Profiles
- Node.js Legacy MIDI Functions
- Rust Migration Governance Rules
- Project README Highlights
- Channel Pair SysEx & 01V96 Mixer
- MIDI Common Crate & Remote MIDI Bridge
- Reverse DLL Scene/Sync Properties
- UI/UX Pro Max Design System Skills
- GitHub Address Comments Skill
- Monitor Log & Legacy Config Snapshots
- DMX Art-Net Auto-Recovery
- Backend & Testing Pattern Skills
- Features Plan (Custom Scenes, Server Name)
- Remote MIDI Implementation Plan
- Karpathy Coding Guidelines Skill
- Docs Writer Skill & Style Guide
- Performance Optimization Plan
- Docs Writer & Style Guide
- FX Slot Scanner & Elevation Test
- Community 35
- ESLint Config
- OpenCode TUI Config
- Agent Skill Lock
- Chat Scraping Capture HTML
- Coding Guidelines (Karpathy)
- JavaScript Mastery Skill
- Community 45
- Community 46
- Slider Restriction Handler
- Mixer State Structure
- Bus Assignment Toggle
- Node.js Best Practices Skill
- Index HTML
- Channel Pair SysEx Offset 18
- Reverse DLL Title Properties
- Graphify Rules
- BM25 Script
- Git Sync (Rust)
- Proxy UDP Macro
...
- name-as-free
- Community 893
- Config Modal (MIDI Ports, Scenes, DMX, Layout)
- Community 895
- Community 896
...
- graphify.md
- FX1 Param 1D (DECAY) tested Combined 0-159 (0.02ms..42.30s) + FX4 Param 12 (Rev Time), 11 (Rev Time), 1C (HOLD)
...
- name_update_char_delay_ms
- open_browser_startup
- outIdx
- port
- remote_midi
...
- rta_peak_hold_time
- rta_smoothing
- scene_recall_delay_ms
- scene_resync_delay_ms
- scene_save_delay_ms
- scheduler_tick_ms
- sistema_iluminacao
- sync_chunk_delay_ms
...
- GlobalState
- HashMap
- kAUXAttenuator/kAttBitShift
- kAUXBalance/kBalance
- kAUXChannelOn/kChannelOn
- kAUXComp/kCompAttack
- kAUXComp/kCompGain
- kAUXComp/kCompKnee
- kAUXComp/kCompLink
- kAUXComp/kCompLocComp
- kAUXComp/kCompOn
- kAUXComp/kCompRatio
- kAUXComp/kCompRelease
- kAUXComp/kCompThreshold
- kAUXComp/kCompType
- kAUXDelay/kOutDelayOn
- kAUXDelay/kOutDelayTime
- kAUXEQ/kEQHiF
- kAUXEQ/kEQHiG
- kAUXEQ/kEQHiMidF
- kAUXEQ/kEQHiMidG
...
- kAUXFader/kFader
- kAUXFader/kFadeTime
- kAUXInsert/kInsertLocInsert
- kAUXInsert/kInsertLocInsertFirst
- kAUXInsert/kInsertOn
- kAUXOutGroup/kBusGroupDynamics1
- kAUXOutGroup/kBusGroupDynamics2
- kAUXOutGroup/kBusGroupDynamics3
- kAUXOutGroup/kBusGroupDynamics4
- kAUXOutGroup/kBusGroupEQ1
- kAUXOutGroup/kBusGroupEQ2
- kAUXOutGroup/kBusGroupEQ3
- kAUXOutGroup/kBusGroupEQ4
- kAUXOutGroup/kBusGroupFader1
- kAUXOutGroup/kBusGroupFader2
- kAUXOutGroup/kBusGroupFader3
- kAUXOutGroup/kBusGroupFader4
- kAUXOutGroup/kBusGroupLevel
- kAUXOutGroup/kBusGroupMute1
- kAUXOutGroup/kBusGroupMute2
- kAUXOutGroup/kBusGroupMute3
- kAUXOutGroup/kBusGroupMute4
- kAUXOutGroup/kOutMasterFaderAsgn
- kAUXOutGroup/kOutMasterMuteAsgn
- kAUXPair/kPair
- kAUXPair/kPairFS
- kAUXToMatrix/kBusToMatrix1Level
- kAUXToMatrix/kBusToMatrix1On
- kAUXToMatrix/kBusToMatrix2Level
- kAUXToMatrix/kBusToMatrix2On
- kAUXToMatrix/kBusToMatrix3Level
- kAUXToMatrix/kBusToMatrix3On
- kAUXToMatrix/kBusToMatrix4Level
- kAUXToMatrix/kBusToMatrix4On
- kAUXToMatrix/kBusToMatrix5Level
- kAUXToMatrix/kBusToMatrix5On
- kAUXToMatrix/kBusToMatrix6Level
- kAUXToMatrix/kBusToMatrix6On
- kAUXToMatrix/kBusToMatrix7Level
- kAUXToMatrix/kBusToMatrix7On
- kAUXToMatrix/kBusToMatrix8Level
- kAUXToMatrix/kBusToMatrix8On
- kAUXToMatrixPan/kBusToMatrixPan0102
- kAUXToMatrixPan/kBusToMatrixPan0304
- kAUXToMatrixPan/kBusToMatrixPan0506
- kAUXToMatrixPan/kBusToMatrixPan0708
- kAUXType/kAUXTypeIndex
- kBusAttenuator/kAtt
- kBusAttenuator/kAttBitShift
- kBusBalance/kBalance
- kBusChannelOn/kChannelOn
- kBusComp/kCompAttack
- kBusComp/kCompGain
- kBusComp/kCompKnee
- kBusComp/kCompLink
- kBusComp/kCompLocComp
- kBusComp/kCompOn
- kBusComp/kCompRatio
- kBusComp/kCompRelease
- kBusComp/kCompThreshold
- kBusComp/kCompType
- kBusDelay/kOutDelayOn
- kBusDelay/kOutDelayTime
- kBusEQ/kEQHiF
- kBusEQ/kEQHiG
- kBusEQ/kEQHiMidF
- kBusEQ/kEQHiMidG
...
- kBusFader/kFader
- kBusFader/kFadeTime
- kBusInsert/kInsertLocInsert
- kBusInsert/kInsertLocInsertFirst
- kBusInsert/kInsertOn
- kBusOutGroup/kBusGroupDynamics1
- kBusOutGroup/kBusGroupDynamics2
- kBusOutGroup/kBusGroupDynamics3
- kBusOutGroup/kBusGroupDynamics4
- kBusOutGroup/kBusGroupEQ1
- kBusOutGroup/kBusGroupEQ2
- kBusOutGroup/kBusGroupEQ3
- kBusOutGroup/kBusGroupEQ4
- kBusOutGroup/kBusGroupFader1
- kBusOutGroup/kBusGroupFader2
- kBusOutGroup/kBusGroupFader3
- kBusOutGroup/kBusGroupFader4
- kBusOutGroup/kBusGroupLevel
- kBusOutGroup/kBusGroupMute1
- kBusOutGroup/kBusGroupMute2
- kBusOutGroup/kBusGroupMute3
- kBusOutGroup/kBusGroupMute4
- kBusOutGroup/kOutMasterFaderAsgn
- kBusOutGroup/kOutMasterMuteAsgn
- kBusPair/kPair
- kBusToMatrix/kBusToMatrix1Level
- kBusToMatrix/kBusToMatrix1On
- kBusToMatrix/kBusToMatrix2Level
- kBusToMatrix/kBusToMatrix2On
- kBusToMatrix/kBusToMatrix3Level
- kBusToMatrix/kBusToMatrix3On
- kBusToMatrix/kBusToMatrix4Level
- kBusToMatrix/kBusToMatrix4On
- kBusToMatrix/kBusToMatrix5Level
- kBusToMatrix/kBusToMatrix5On
- kBusToMatrix/kBusToMatrix6Level
- kBusToMatrix/kBusToMatrix6On
- kBusToMatrix/kBusToMatrix7Level
- kBusToMatrix/kBusToMatrix7On
- kBusToMatrix/kBusToMatrix8Level
- kBusToMatrix/kBusToMatrix8On
- kBusToMatrixPan/kBusToMatrixPan0102
- kBusToMatrixPan/kBusToMatrixPan0304
- kBusToMatrixPan/kBusToMatrixPan0506
- kBusToMatrixPan/kBusToMatrixPan0708
- kBusToStereo/kBusToStereoLevel
- kBusToStereo/kBusToStereoOn
- kBusToStereo/kBusToStereoPan
- kInputAttenuator/kAtt
- kInputAttenuator/kAttBitShift
- kInputAUX/kAUX10Level
- kInputAUX/kAUX10On
- kInputAUX/kAUX10Pre
- kInputAUX/kAUX11Level
- kInputAUX/kAUX11On
- kInputAUX/kAUX11Pre
- kInputAUX/kAUX12Level
- kInputAUX/kAUX12On
- kInputAUX/kAUX12Pre
- kInputAUX/kAUX1Level
- kInputAUX/kAUX1On
- kInputAUX/kAUX1Pre
- kInputAUX/kAUX2Level
- kInputAUX/kAUX2On
- kInputAUX/kAUX2Pre
- kInputAUX/kAUX3Level
- kInputAUX/kAUX3On
- kInputAUX/kAUX3Pre
- kInputAUX/kAUX4Level
- kInputAUX/kAUX4On
- kInputAUX/kAUX4Pre
- kInputAUX/kAUX5Level
- kInputAUX/kAUX5On
- kInputAUX/kAUX5Pre
- kInputAUX/kAUX6Level
- kInputAUX/kAUX6On
- kInputAUX/kAUX6Pre
- kInputAUX/kAUX7Level
- kInputAUX/kAUX7On
- kInputAUX/kAUX7Pre
- kInputAUX/kAUX8Level
- kInputAUX/kAUX8On
- kInputAUX/kAUX8Pre
- kInputAUX/kAUX9Level
- kInputAUX/kAUX9On
- kInputAUX/kAUX9Pre
- kInputAUXPan/kAUX0102Pan
- kInputAUXPan/kAUX0304Pan
- kInputAUXPan/kAUX0506Pan
- kInputAUXPan/kAUX0708Pan
- kInputAUXPan/kAUX0910Pan
- kInputAUXPan/kAUX1112Pan
- kInputBus/kBus1
- kInputBus/kBus2
- kInputBus/kBus3
- kInputBus/kBus4
...
- kInputChannelPan/kChannelPan
- kInputComp/kCompAttack
- kInputComp/kCompGain
- kInputComp/kCompKnee
- kInputComp/kCompLink
- kInputComp/kCompLocComp
- kInputComp/kCompOn
- kInputComp/kCompRatio
- kInputComp/kCompRelease
- kInputComp/kCompThreshold
- kInputComp/kCompType
- kInputDelay/kInDelayFBGain
- kInputDelay/kInDelayMix
- kInputDelay/kInDelayOn
- kInputDelay/kInDelayTime
- kInputEQ/kEQHiF
- kInputEQ/kEQHiG
- kInputEQ/kEQHiMidF
- kInputEQ/kEQHiMidG
...
- kInputEQ/kEQOn
- kInputFader/kFader
- kInputFader/kFadeTime
- kInputGate/kGateAttack
- kInputGate/kGateDecay
- kInputGate/kGateHold
- kInputGate/kGateKeyAUX
- kInputGate/kGateKeyCh
- kInputGate/kGateKeyIn
- kInputGate/kGateLink
- kInputGate/kGateOn
- kInputGate/kGateRange
- kInputGate/kGateThreshold
- kInputGate/kGateType
- kInputGroup/kInGroupDynamics1
- kInputGroup/kInGroupDynamics2
- kInputGroup/kInGroupDynamics3
- kInputGroup/kInGroupDynamics4
- kInputGroup/kInGroupEQ1
- kInputGroup/kInGroupEQ2
- kInputGroup/kInGroupEQ3
- kInputGroup/kInGroupEQ4
- kInputGroup/kInGroupFader1
- kInputGroup/kInGroupFader2
- kInputGroup/kInGroupFader3
- kInputGroup/kInGroupFader4
- kInputGroup/kInGroupFader5
- kInputGroup/kInGroupFader6
- kInputGroup/kInGroupFader7
- kInputGroup/kInGroupFader8
- kInputGroup/kInGroupLevel
- kInputGroup/kInGroupMute1
- kInputGroup/kInGroupMute2
- kInputGroup/kInGroupMute3
- kInputGroup/kInGroupMute4
- kInputGroup/kInGroupMute5
- kInputGroup/kInGroupMute6
- kInputGroup/kInGroupMute7
- kInputGroup/kInGroupMute8
- kInputGroup/kInMasterFaderAsgn
- kInputGroup/kInMasterMuteAsgn
- kInputInsert/kInsertLocInsert
- kInputInsert/kInsertLocInsertFirst
- kInputInsert/kInsertOn
- kInputPair/kPair
- kInputPair/kPairMS
- kInputPhase/kPhase
- kInputRouting/kRoutingBus1
- kInputRouting/kRoutingBus2
- kInputRouting/kRoutingBus3
- kInputRouting/kRoutingBus4
- kInputRouting/kRoutingBus5
- kInputRouting/kRoutingBus6
- kInputRouting/kRoutingBus7
- kInputRouting/kRoutingBus8
- kInputRouting/kRoutingDirect
- kInputRouting/kRoutingPan
- kInputRouting/kRoutingStereo
- kInputSurround/kSurroundDepth
- kInputSurround/kSurroundDirection
- kInputSurround/kSurroundDiv
- kInputSurround/kSurroundDivLink
- kInputSurround/kSurroundDivRear
- kInputSurround/kSurroundLFE
- kInputSurround/kSurroundLink
- kInputSurround/kSurroundOffsetX
- kInputSurround/kSurroundOffsetY
- kInputSurround/kSurroundPattLink
- kInputSurround/kSurroundWidth
- kInputSurround/kSurroundX
- kInputSurround/kSurroundY
- kMatrixAttenuator/kAtt
- kMatrixAttenuator/kAttBitShift
- kMatrixBalance/kBalance
- kMatrixChannelOn/kChannelOn
- kMatrixComp/kCompAttack
- kMatrixComp/kCompGain
- kMatrixComp/kCompKnee
- kMatrixComp/kCompLink
- kMatrixComp/kCompLocComp
- kMatrixComp/kCompOn
- kMatrixComp/kCompRatio
- kMatrixComp/kCompRelease
- kMatrixComp/kCompThreshold
- kMatrixComp/kCompType
- kMatrixDelay/kOutDelayOn
- kMatrixDelay/kOutDelayTime
- kMatrixEQ/kEQHiF
- kMatrixEQ/kEQHiG
- kMatrixEQ/kEQHiMidF
- kMatrixEQ/kEQHiMidG
...
- kMatrixEQ/kEQLowF
- kMatrixEQ/kEQLowG
- kMatrixEQ/kEQLowMidF
- kMatrixEQ/kEQLowMidG
- kMatrixEQ/kEQLowMidQ
- kMatrixEQ/kEQLowQ
- kMatrixEQ/kEQMode
- kMatrixEQ/kEQOn
- kMatrixFader/kFader
- kMatrixFader/kFadeTime
- kMatrixInsert/kInsertLocInsert
- kMatrixInsert/kInsertLocInsertFirst
- kMatrixInsert/kInsertOn
- kMatrixOutGroup/kBusGroupDynamics1
- kMatrixOutGroup/kBusGroupDynamics2
- kMatrixOutGroup/kBusGroupDynamics3
- kMatrixOutGroup/kBusGroupDynamics4
- kMatrixOutGroup/kBusGroupEQ1
- kMatrixOutGroup/kBusGroupEQ2
- kMatrixOutGroup/kBusGroupEQ3
- kMatrixOutGroup/kBusGroupEQ4
- kMatrixOutGroup/kBusGroupFader1
- kMatrixOutGroup/kBusGroupFader2
- kMatrixOutGroup/kBusGroupFader3
- kMatrixOutGroup/kBusGroupFader4
- kMatrixOutGroup/kBusGroupLevel
- kMatrixOutGroup/kBusGroupMute1
- kMatrixOutGroup/kBusGroupMute2
- kMatrixOutGroup/kBusGroupMute3
- kMatrixOutGroup/kBusGroupMute4
- kMatrixOutGroup/kOutMasterFaderAsgn
- kMatrixOutGroup/kOutMasterMuteAsgn
- kMatrixPair/kPair
- kNumModules/kAD824ModuleNum
- kNumModules/kAUXModuleNum
- kNumModules/kBusModuleNum
- kNumModules/kEffectModuleNum
- kNumModules/kGEQModuleNum
- kNumModules/kInputModuleNum
- kNumModules/kMatrixModuleNum
- kNumModules/kPlugInModuleNum
- kNumModules/kRemoteModuleNum
- kNumModules/kStereoModuleNum
- kSceneAttribute/kAttribute
- kSceneDelayMode/kDelayMode
- kSceneDirectOutPre/kDirectOutPre
- kSceneInputGroup/kInDynamicsGroup1
- kSceneInputGroup/kInDynamicsGroup2
- kSceneInputGroup/kInDynamicsGroup3
- kSceneInputGroup/kInDynamicsGroup4
- kSceneInputGroup/kInEQGroup1
- kSceneInputGroup/kInEQGroup2
- kSceneInputGroup/kInEQGroup3
- kSceneInputGroup/kInEQGroup4
- kSceneInputGroup/kInFaderGroup1
- kSceneInputGroup/kInFaderGroup2
- kSceneInputGroup/kInFaderGroup3
- kSceneInputGroup/kInFaderGroup4
- kSceneInputGroup/kInFaderGroup5
- kSceneInputGroup/kInFaderGroup6
- kSceneInputGroup/kInFaderGroup7
- kSceneInputGroup/kInFaderGroup8
- kSceneInputGroup/kInFaderGrpMasterEnable
- kSceneInputGroup/kInGroupLevelIndex
- kSceneInputGroup/kInMuteGroup1
- kSceneInputGroup/kInMuteGroup2
- kSceneInputGroup/kInMuteGroup3
- kSceneInputGroup/kInMuteGroup4
- kSceneInputGroup/kInMuteGroup5
- kSceneInputGroup/kInMuteGroup6
- kSceneInputGroup/kInMuteGroup7
- kSceneInputGroup/kInMuteGroup8
- kSceneInputGroup/kInMuteGrpMasterEnable
- kSceneMatrixSend/kMatrixSendPre
- kSceneNumber
- kSceneNumberFallback
- kSceneOutputGroup/kOutDynamicsGroup1
- kSceneOutputGroup/kOutDynamicsGroup2
- kSceneOutputGroup/kOutDynamicsGroup3
- kSceneOutputGroup/kOutDynamicsGroup4
- kSceneOutputGroup/kOutEQGroup1
- kSceneOutputGroup/kOutEQGroup2
- kSceneOutputGroup/kOutEQGroup3
- kSceneOutputGroup/kOutEQGroup4
- kSceneOutputGroup/kOutFaderGroup1
- kSceneOutputGroup/kOutFaderGroup2
- kSceneOutputGroup/kOutFaderGroup3
- kSceneOutputGroup/kOutFaderGroup4
- kSceneOutputGroup/kOutFaderGrpMasterEnable
- kSceneOutputGroup/kOutGroupLevel
- kSceneOutputGroup/kOutMuteGroup1
- kSceneOutputGroup/kOutMuteGroup2
- kSceneOutputGroup/kOutMuteGroup3
- kSceneOutputGroup/kOutMuteGroup4
- kSceneOutputGroup/kOutMuteGrpMasterEnable
- kScenePairMode/kPairMode
- kScenePanLink/kPanLinkAUX0102
- kScenePanLink/kPanLinkAUX0304
- kScenePanLink/kPanLinkAUX0506
- kScenePanLink/kPanLinkAUX0708
- kScenePanLink/kPanLinkAUX0910
- kScenePanLink/kPanLinkAUX1112
- kScenePanMode/kPanModeAUX0102
- kScenePanMode/kPanModeAUX0304
- kScenePanMode/kPanModeAUX0506
- kScenePanMode/kPanModeAUX0708
- kScenePanMode/kPanModeAUX0910
- kScenePanMode/kPanModeAUX1112
- kScenePanMode/kPanModeChannel
- kScenePatchLink/kInPatchLinkNo
- kScenePatchLink/kInPatchLinkOn
- kScenePatchLink/kOutPatchLinkNo
- kScenePatchLink/kOutPatchLinkOn
- kSceneRecallSafeAUX/kRecallSafeIndex
- kSceneRecallSafeBus/kRecallSafeIndex
- kSceneRecallSafeEffect/kRecallSafeIndex
- kSceneRecallSafeEnable/kRecallSafeEnable
- kSceneRecallSafeEnable/kRecallSafeIndMode
- kSceneRecallSafeEnable/kRecallSafeMode
- kSceneRecallSafeGEQ/kRecallSafeIndex
- kSceneRecallSafeIn/kRecallSafeIndex
- kSceneRecallSafeMatrix/kRecallSafeIndex
- kSceneRecallSafeStereo/kRecallSafeIndex
- kSceneSurroundMode/kSurroundMode
- kSceneTitle/kTitle1
- kSceneTitle/kTitle10
- kSceneTitle/kTitle11
- kSceneTitle/kTitle12
- kSceneTitle/kTitle13
- kSceneTitle/kTitle14
- kSceneTitle/kTitle15
- kSceneTitle/kTitle16
- kSceneTitle/kTitle2
- kSceneTitle/kTitle3
- kSceneTitle/kTitle4
- kSceneTitle/kTitle5
...
- kSceneTitle/kTitle8
- kSceneTitle/kTitle9
- kSceneVersion/kVersion
- kStereoAttenuator/kAtt
- kStereoAttenuator/kAttBitShift
- kStereoBalance/kBalance
- kStereoChannelOn/kChannelOn
- kStereoComp/kCompAttack
- kStereoComp/kCompGain
- kStereoComp/kCompKnee
- kStereoComp/kCompLink
- kStereoComp/kCompLocComp
- kStereoComp/kCompOn
- kStereoComp/kCompRatio
- kStereoComp/kCompRelease
- kStereoComp/kCompThreshold
- kStereoComp/kCompType
- kStereoEQ/kEQMode
- kStereoFader/kFader
- kStereoFader/kFadeTime
- kStereoInsert/kInsertLocInsert
- kStereoInsert/kInsertLocInsertFirst
- kStereoInsert/kInsertOn
- kStereoPair/kPair
- kAUXEQ/kEQLPFOn
- kBusEQ/kEQLPFOn
- kInputEQ/kEQLPFOn
...
3. `CustomSceneManager` - 47 edges
4. `ConnectionManager` - 43 edges
5. `GlobalState` - 42 edges
6. `CeltMode` - 39 edges
...
## Communities (7836 total, 6869 thin omitted)
...
Cohesion: 0.12
Nodes (12): Serialize, ChannelNameEntry, CustomScene, CustomSceneManager, CustomSceneRegistry, HashMap, HashSet, Option (+4 more)
...
Cohesion: 0.08
Nodes (21): Bad, Bitflags for Boolean Sets, Conversion Safety, Good, Integer Size Reference, mem-smaller-integers, NonZero Types for Option Optimization, See Also (+13 more)
...
Cohesion: 0.10
Nodes (33): F, delete_env(), detect_env_status(), EnvStatus, get_env_path(), is_setup_complete(), load_env_map(), load_env_map_from() (+25 more)
...
Cohesion: 0.12
Nodes (19): FxSyncAck, apply_comp_fields(), ChannelLike, ChannelState, CompState, EqBand, EqState, FxTypeState (+11 more)
...
Cohesion: 0.08
Nodes (59): _ensure_gh_authenticated(), fetch_all(), get_current_pr_ref(), gh_api_graphql(), gh_pr_view_json(), main(), Resolve the PR for the current branch (whatever gh considers associated).     Wo, Call `gh api graphql` using -F variables, avoiding JSON blobs with nulls.     Qu (+51 more)
...
Cohesion: 0.21
Nodes (11): get_physical_short(), push_req(), queue_all_params_inner(), Arc, AtomicBool, RwLock, Self, SocketIo (+3 more)

### Community 100 - "Community 100"
Cohesion: 0.22
Nodes (9): MidiScheduler, Arc, Mutex, Option, Self, String, Vec, SchedulerState (+1 more)
...
Cohesion: 0.12
Nodes (36): build_pan_change(), build_pan_request(), build_pan_sync_requests(), bytes_to_pan_value(), global_channel_to_pan_index(), pan_value_to_bytes(), PanTarget, parse_pan_message() (+28 more)
...
Cohesion: 0.20
Nodes (16): collect_current_channels_as_entries(), collect_current_names(), ControlData, get_channel_short_name(), PanData, register_handlers(), require_setup(), Arc (+8 more)

### Community 111 - "Community 111"
Cohesion: 0.15
Nodes (12): 2.1. Conversão de Frequências (Padrão Yamaha), 2. Estrutura e Arquitetura Proposta, 4. Tabela de Referência: HOLD (0x1C), 5. Tabela de Referência: DECAY (0x1D), 7.1. Tela de Máquinas de Efeitos — Etapa 1 (Mockada), 7. Progresso da Implementação (Frontend), 9.1. Arquitetura da Sincronização Sequencial, 9.2. Ajuste Fino de Latência de Hardware (+4 more)
...
Cohesion: 0.10
Nodes (22): Default, Self, SilkDecoder, test_decoder_16khz(), test_decoder_creation(), test_decoder_init(), silk_decode_frame(), silk_decode_indices() (+14 more)
...
Cohesion: 0.09
Nodes (15): AtomicUsize, MasterMeter, HashMap, Option, Self, Value, Vec, Arc (+7 more)

### Community 129 - "Community 129"
Cohesion: 0.11
Nodes (14): api-typestate, Bad, Builder Typestate, Good, See Also, Transaction Example, Why It Matters, Bad (+6 more)
...
Cohesion: 0.13
Nodes (34): silk_ana_filt_bank_1(), silk_biquad_alt_stride1(), silk_biquad_alt_stride2(), silk_decode_core(), silk_lpc_analysis_filter_offset(), silk_add_pos_sat32(), silk_div32(), silk_rshift() (+26 more)

### Community 135 - "Community 135"
Cohesion: 0.14
Nodes (5): MeterEngine, Self, Vec, MidiAssembler, RemoteClient
...
Cohesion: 0.14
Nodes (23): silk_find_pred_coefs_fix(), silk_ltp_scale_ctrl_fix(), silk_float_to_fixed_q7(), silk_quant_ltp_gains(), silk_log2lin(), silk_ltp_analysis_filter_fix(), silk_limit(), silk_mla() (+15 more)

### Community 144 - "Community 144"
Cohesion: 0.14
Nodes (17): D, Display, Err, Formatter, FromStr, Ok, S, ChannelId (+9 more)
...
Cohesion: 0.09
Nodes (15): Bad, doc-all-public, Enforcement, Good, See Also, What to Document, Why It Matters, Bad (+7 more)
...
Cohesion: 0.07
Nodes (27): Bad, Common RAII Patterns, Good, scopeguard Crate, See Also, test-fixture-raii, Why It Matters, Basic Usage (+19 more)
...
Cohesion: 0.08
Nodes (25): Bad, Build Time Trade-offs, Full Release Profile, Good, How It Works, Measuring Impact, opt-codegen-units, Per-Profile Configuration (+17 more)
...
Cohesion: 0.09
Nodes (22): anti-premature-optimize, Bad, Common Premature Optimizations, Document Optimizations, Good, Optimization Principles, Profile Tools, Profiling Workflow (+14 more)
...
Cohesion: 0.15
Nodes (7): CancellationToken, CachedScene, CustomSceneOpQueue, test_channel_id_serialize_roundtrip(), test_registry_entry_management(), test_remove_channel_with_deletion(), SystemTime
...
Cohesion: 0.09
Nodes (17): anti-over-abstraction, Bad, Good, Prefer Concrete Types in Private Code, Rule of Three, See Also, Signs of Over-Abstraction, When to Generalize (+9 more)
...
Cohesion: 0.10
Nodes (31): alloc_trim_analysis(), AnalysisInfo, CeltEncoder, comb_filter(), comb_filter_const(), comb_filter_const_avx(), comb_filter_const_neon(), comb_filter_const_neon_impl() (+23 more)
...
Cohesion: 0.05
Nodes (38): Bad, Categories, doc-cargo-metadata, Good, Include/Exclude, Keywords Best Practices, License Patterns, Recommended Fields (+30 more)
...
Cohesion: 0.09
Nodes (21): Bad, doc-hidden-setup, Good, Pattern: Hiding Multi-Line Setup, Pattern: `ignore` and `no_run`, Pattern: Showing Setup When Relevant, See Also, What to Hide (+13 more)
...
Cohesion: 0.12
Nodes (15): anti-panic-expected, Anti-pattern: panic! for Control Flow, Bad, Decision Guide, Good, See Also, When to Panic, Why It Matters (+7 more)
...
Cohesion: 0.05
Nodes (31): anti-expect-lazy, Bad, Decision Guide, Good, See Also, When expect() Is Appropriate, Why It Matters, anti-panic-expected (+23 more)
...
Cohesion: 0.11
Nodes (15): Bad, Good, name-variants-camel, See Also, Variant Naming Tips, Variants with Data, Why It Matters, Bad (+7 more)
...
Cohesion: 0.05
Nodes (40): async-broadcast-pubsub, Bad, Broadcast Semantics, Broadcast vs Watch, Clone Requirement, Event Bus Pattern, Good, Handling Lagging Receivers (+32 more)
...
Cohesion: 0.83
Nodes (3): combine_pulses(), encode_split(), silk_shell_encoder()
...
Cohesion: 0.11
Nodes (38): hp_cutoff(), silk_process_gains_fix(), silk_encode_frame(), silk_gains_dequant(), silk_gains_id(), silk_gains_quant(), silk_lin2log(), silk_burg_modified_fix() (+30 more)
...
Cohesion: 0.09
Nodes (16): RangeCoder, Self, Vec, test_bits_only(), test_icdf_consistency(), test_icdf_decode_terminates(), test_icdf_last_symbol_no_oob(), test_interleaved_bits_entropy() (+8 more)
...
Cohesion: 0.36
Nodes (12): silk_add_lshift32(), silk_limit_32(), silk_rand(), lpc_pred_generic(), lpc_pred_order10(), lpc_pred_order16(), lpc_pred_order6(), silk_noise_shape_quantizer() (+4 more)
...
Cohesion: 0.11
Nodes (21): silk_control_encoder(), silk_setup_complexity(), silk_setup_fs(), silk_encode(), silk_encode_do_vad(), silk_encode_prefill(), silk_encode_indices(), combine_and_check() (+13 more)
...
Cohesion: 0.11
Nodes (24): Into, silk_control_snr(), fix_const_q16(), fix_const_q7(), silk_hp_variable_cutoff(), silk_add32_ovflw(), silk_lshift(), silk_sub32_ovflw() (+16 more)
...
Cohesion: 0.12
Nodes (25): denormalise_bands(), log2amp(), normalise_bands(), scale_slice_avx2(), scale_slice_neon(), CeltDecoder, comb_filter_inplace(), tf_decode() (+17 more)
...
Cohesion: 0.11
Nodes (15): Bad, Good, Module Structure, Multiple Test Modules, See Also, test-cfg-test-module, Test Helpers, Why It Matters (+7 more)
...
## Knowledge Gaps
- **10725 isolated node(s):** `@opencode-ai/plugin`, `@opencode-ai/plugin`, `QueryTarget`, `midi`, `fs` (+10720 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **6869 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `OpusEncoder` connect `Karpathy Coding Guidelines Skill` to `Community 1381`, `Community 1221`, `Community 133`, `Community 1457`, `Community 657`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `RangeCoder` connect `Community 1221` to `Community 1604`, `Community 1381`, `shell_coder.rs`, `Community 657`, `Community 115`, `Community 855`, `Karpathy Coding Guidelines Skill`, `Community 1181`, `Community 1119`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
...
- **What connects `Resolve the PR for the current branch (whatever gh considers associated).     Wo`, `Call `gh api graphql` using -F variables, avoiding JSON blobs with nulls.     Qu`, `BM25 ranking algorithm for text search` to the rest of the system?**
  _10757 weakly-connected nodes found - possible documentation gaps or missing edges._
