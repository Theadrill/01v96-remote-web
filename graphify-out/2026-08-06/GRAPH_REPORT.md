# Graph Report - 01v96-remote-web  (2026-08-06)

## Corpus Check
- 651 files · ~13,043,352 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22164 nodes · 24436 edges · 5718 communities (2572 shown, 3146 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 1180 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f9315cb8`
...
## Communities (5718 total, 3146 thin omitted)
...
Cohesion: 0.04
Nodes (50): anti-lock-across-await, Bad, Detection, Good, Pattern: Clone Before Await, Pattern: Restructure to Avoid Lock, See Also, What Can Cross Await (+42 more)
...
Cohesion: 0.14
Nodes (16): SilkEncoderState, Self, silk_control_encoder(), silk_setup_complexity(), silk_setup_fs(), rate_id(), ResamplerMode, silk_resampler_down2() (+8 more)

### Community 27 - "Docs Writer Skill & Style Guide"
Cohesion: 0.07
Nodes (21): WasmRta, cachedTextDecoder, cachedTextEncoder, decodeText(), getArrayF32FromWasm0(), getArrayJsValueFromWasm0(), getDataViewMemory0(), getFloat32ArrayMemory0() (+13 more)
...
Cohesion: 0.09
Nodes (21): Bad, Built-in Const Assertions, Cargo.toml, Documenting Size Constraints, Good, mem-assert-type-size, See Also, static_assertions Crate (+13 more)
...
Cohesion: 0.17
Nodes (8): midi, dependencies, midi, input, midi, output, REQUESTS, { yamahaIn, yamahaOut }
...
Cohesion: 0.13
Nodes (14): apply_comp_fields(), ChannelLike, ChannelState, CompState, EqBand, EqState, FxTypeState, GateState (+6 more)
...
Cohesion: 0.12
Nodes (33): RtaManager, collect_current_channels_as_entries(), collect_current_names(), ControlData, get_channel_short_name(), PanData, register_handlers(), require_setup() (+25 more)
...
Cohesion: 0.12
Nodes (29): animateMeterDemo(), closeFxEditor(), decodeParams(), getParamInfoFromElement(), handleWheelKnob(), hideEditorSyncOverlay(), invalidateSyncedSlots(), isModalOpen() (+21 more)
...
Cohesion: 0.07
Nodes (28): api-newtype-safety, Bad, Constructor Patterns, Derive Common Traits, Good, See Also, When Newtypes Help Most, Why It Matters (+20 more)
...
Cohesion: 0.14
Nodes (16): silk_decode_frame(), silk_decode_indices(), silk_decode_parameters(), silk_decode_pitch(), SilkDecoderControl, SilkDecoderState, SilkPLCState, combine_and_check() (+8 more)
...
Cohesion: 0.09
Nodes (38): silk_residual_energy_fix(), silk_find_ltp_fix(), silk_add32(), silk_add_sat16(), silk_add_sat32(), silk_clz32(), silk_rshift32(), silk_sub32() (+30 more)
...
Cohesion: 0.10
Nodes (15): RangeCoder, test_bits_only(), test_icdf_consistency(), test_icdf_decode_terminates(), test_icdf_last_symbol_no_oob(), test_interleaved_bits_entropy(), test_laplace(), decode_split() (+7 more)
...
Cohesion: 0.40
Nodes (15): CeltMode, RangeCoder, BandCtx, quant_partition(), quant_partition_direct_encode(), quant_partition_encode(), quant_partition_n2_encode(), quant_partition_n4_encode() (+7 more)
...
Cohesion: 0.11
Nodes (17): 1.1. Ajustar o Endpoint `get_slots` (Leitura Dinâmica por Sync), 1.2. Criar Endpoint de Comparação `GET /api/macros/compare`, 1.3. Criar/Verificar Endpoint de Check de Conexão `GET /api/macros/sync/check`, 1. Contexto e Diagnóstico, 2.1. Adicionar o Modal `#macroSyncDiffModal` no HTML, 2.2. Adicionar Estilos no CSS, 2. Regras de Negócio e Princípios Arquiteturais, 3.1. Atualizar `loadGlobalSlotsManifest()` (+9 more)
...
Cohesion: 0.08
Nodes (24): BOLT Post-Link Optimization, Build Script, Cargo Configuration, CI/CD Integration, opt-pgo-profile, Representative Workloads, See Also, Step-by-Step (+16 more)
...
Cohesion: 0.12
Nodes (15): §10 Telas de Efeitos (Lazy-Sync e Regras), §11 Registro de Descobertas e Soluções, §12 Multiband Compressor (M.BAND DYNA.), §1 Endereçamento de Parâmetros (Controle Direto), §2 Frequências (Padrão Yamaha), §3 Reverb Standard (IDs 0, 1, 2, 3 — Hall/Room/Stage/Plate), §4 Tabela HOLD completa, §5 Tabela DECAY completa (+7 more)

### Community 587 - "Community 587"
Cohesion: 0.06
Nodes (36): files, main, name, sideEffects, type, types, version, files (+28 more)
...
Cohesion: 0.08
Nodes (41): SideInfoIndices, SilkEncoderStateCommon, SilkNSQState, silk_float_to_fixed_q7(), silk_gains_dequant(), silk_gains_id(), silk_gains_quant(), silk_quant_ltp_gains() (+33 more)
...
Cohesion: 0.06
Nodes (31): api-serde-optional, Bad, Feature Documentation, Good, Macro Pattern, Multiple Optional Dependencies, See Also, Testing with Features (+23 more)
...
Cohesion: 0.05
Nodes (39): Async Tests, Bad, Complex Arrange, Good, Helper Functions, See Also, test-arrange-act-assert, Why It Matters (+31 more)

### Community 635 - "Community 635"
Cohesion: 0.12
Nodes (15): 1. Visão Geral da Funcionalidade e Mapeamento Confirmado, 2.1. Valores de Referência dos Steps, 2.2. Fórmula de Cálculo da Largura da Barra (`width %`), 2.3. Layout Visual dos Marcadores e Preenchimento, 2. Escala de Conversão e Regra de Preenchimento (Validado em Mesa Física), 3. Arquitetura e Arquivos Modificados, 4. Instruções de Delegação para o OpenCode (Prompt de Execução), 5. Status da Documentação (+7 more)
...
Cohesion: 0.04
Nodes (46): Bad, Combining with thiserror, err-anyhow-app, Error Display Formats, Good, Key Features, Main Function Pattern, See Also (+38 more)
...
Cohesion: 0.10
Nodes (18): api-impl-asref, AsRef vs Into vs Borrow, Bad, Common AsRef Implementations, Good, Implement AsRef for Custom Types, Pattern: Optional AsRef Bound, See Also (+10 more)
...
Cohesion: 0.12
Nodes (26): alloc_trim_analysis(), CeltEncoder, comb_filter(), comb_filter_const(), comb_filter_const_avx(), comb_filter_const_neon(), comb_filter_const_neon_impl(), comb_filter_const_scalar() (+18 more)
...
Cohesion: 0.05
Nodes (41): Assertions and Invariants, Bad, Combining with #[inline(never)], Common Cold Patterns, Good, Measuring Impact, opt-cold-unlikely, See Also (+33 more)

### Community 657 - "Community 657"
Cohesion: 0.22
Nodes (8): description, license, main, name, scripts, start, type, version
...
Cohesion: 0.21
Nodes (12): rate_id(), ResamplerMode, Default, silk_resampler_down2(), silk_resampler_down2_3(), silk_resampler_down_1_3(), silk_resampler_down_1_6(), silk_resampler_private_ar2() (+4 more)

### Community 663 - "Community 663"
Cohesion: 0.13
Nodes (25): silk_find_pred_coefs_fix(), silk_ltp_scale_ctrl_fix(), silk_float_to_fixed_q7(), silk_quant_ltp_gains(), silk_ltp_analysis_filter_fix(), silk_limit(), silk_limit_32(), silk_mla() (+17 more)
...
Cohesion: 0.10
Nodes (36): SilkEncoderControl, SilkEncoderState, SilkEncoderControl, SilkEncoderState, SilkEncoderState, silk_ana_filt_bank_1(), silk_find_pred_coefs_fix(), silk_ltp_scale_ctrl_fix() (+28 more)
...
Cohesion: 0.09
Nodes (20): API Patterns, ArrayString for Stack Strings, ArrayVec vs SmallVec vs Vec, Bad, Cargo.toml, Good, mem-arrayvec, See Also (+12 more)
...
Cohesion: 0.16
Nodes (17): silk_add_rshift(), silk_interpolate(), silk_interpolate_inplace(), energy_flp(), inner_product_flp(), lpc_inverse_pred_gain_qa(), silk_burg_modified_flp(), silk_find_lpc_fix() (+9 more)
...
Cohesion: 0.09
Nodes (20): Bad, Check Enum Sizes, Clippy Lint, Good, mem-box-large-variant, Pattern Matching with Boxed Variants, Recursive Types Require Boxing, See Also (+12 more)
...
Cohesion: 0.05
Nodes (38): Assertions and Invariants, Bad, Combining with #[inline(never)], Common Cold Patterns, Good, Measuring Impact, opt-cold-unlikely, See Also (+30 more)
...
Cohesion: 0.18
Nodes (7): Self, SilkDecoder, test_decoder_16khz(), test_decoder_creation(), test_decoder_init(), silk_stereo_decode_mid_only(), silk_stereo_decode_pred()

### Community 769 - "Community 769"
Cohesion: 0.19
Nodes (13): energy_flp(), inner_product_flp(), lpc_inverse_pred_gain_qa(), silk_burg_modified_flp(), silk_lpc_inverse_pred_gain(), silk_residual_energy_fix(), silk_clz32(), silk_rshift_round64() (+5 more)
...
Cohesion: 0.04
Nodes (46): Async Tests, Bad, Complex Arrange, Good, Helper Functions, See Also, test-arrange-act-assert, Why It Matters (+38 more)
...
Cohesion: 0.04
Nodes (51): anti-premature-optimize, Bad, Common Premature Optimizations, Document Optimizations, Good, Optimization Principles, Profile Tools, Profiling Workflow (+43 more)
...
Cohesion: 0.16
Nodes (19): applyFxInputs(), applyFxOutputs(), applyFxTypes(), dispatchFxRequests(), findAllFxOutputDests(), findFxOutputDest(), fxInputLabel(), fxInputPatchClass() (+11 more)
...
Cohesion: 0.09
Nodes (20): Bad, Categories, doc-cargo-metadata, Good, Include/Exclude, Keywords Best Practices, License Patterns, Recommended Fields (+12 more)
...
Cohesion: 0.03
Nodes (67): Bad, Bumpalo Collections, Evidence from ROC Compiler, Good, mem-arena-allocator, Performance Impact, See Also, Thread-Local Scratch Arena Pattern (+59 more)
...
Cohesion: 0.03
Nodes (63): Alternatives to Clone, anti-clone-excessive, Bad, Detecting Excessive Clones, Good, Pattern: Clone on Write, See Also, When to Clone (+55 more)
...
Cohesion: 0.03
Nodes (59): async-bounded-channel, Bad, Channel Types, Choosing Buffer Size, Good, Handling Full Channel, See Also, Why It Matters (+51 more)
...
Cohesion: 0.06
Nodes (32): Bad, Good, Module Structure, Multiple Test Modules, See Also, test-cfg-test-module, Test Helpers, Why It Matters (+24 more)

### Community 847 - "Community 847"
Cohesion: 0.09
Nodes (20): Abort on Drop, async-joinset-structured, Bad, Dynamic Task Addition, Error Handling Pattern, Good, JoinSet vs join_all, See Also (+12 more)
...
Cohesion: 0.07
Nodes (28): api-builder-must-use, Apply to Entire Type, Bad, Clippy Lint, Good, Message Guidelines, See Also, Standard Library Examples (+20 more)
...
Cohesion: 0.27
Nodes (10): controllerRef(), degFromPct(), renderHeader(), renderKnob(), renderLayoutPicker(), renderMeterColumn(), renderMeters(), renderSelectorCard() (+2 more)
...
Cohesion: 0.08
Nodes (85): hp_cutoff(), silk_ana_filt_bank_1(), silk_biquad_alt_stride1(), silk_biquad_alt_stride2(), silk_process_gains_fix(), silk_decode_core(), silk_lpc_analysis_filter_offset(), silk_encode_frame() (+77 more)
...
Cohesion: 0.10
Nodes (33): CeltDecoder, CeltEncoder, Box, Option, RangeCoder, SilkEncoderState, SilkEncoderState, silk_init_encoder() (+25 more)
...
Cohesion: 0.11
Nodes (40): MaybeUninit, alg_quant(), alg_quant_qext(), alg_quant_resynth_avx2(), alg_quant_resynth_neon(), alg_quant_resynth_scalar(), alg_unquant(), celt_pvq_u() (+32 more)
...
Cohesion: 0.29
Nodes (6): WasmRta, InitInput, InitOutput, MeterEngine, MidiDispatcher, SyncInitInput
...
Cohesion: 0.29
Nodes (7): 8.3.1. Elementos SysEx por família de destino, 8.3.2. Tabela completa destino UI → endereço de change, 8.3.3. Exemplos de SysEx por família (FX1 Out1 = 121), 8.3. Catálogo UI de destinos (print SM 2026-07-17), Grid visual (labels do print), Grid visual (labels do print), Grid visual (labels do print)
...
Cohesion: 0.07
Nodes (37): silk_control_encoder(), silk_setup_complexity(), silk_setup_fs(), silk_control_snr(), silk_encode(), silk_encode_do_vad(), silk_encode_prefill(), silk_encode_indices() (+29 more)
...
Cohesion: 0.05
Nodes (39): Bad, Good, In snake_case, Mixed Cases, name-acronym-word, See Also, Standard Library Examples, Two-Letter Acronyms (+31 more)
...
Cohesion: 0.33
Nodes (6): 12.1. Tabela Geral de Parâmetros, 12.2. Regras de Interdependência dos Crossovers (L-M XOVR e M-H XOVR), 12.3.1. Estrutura do SysEx de Requisição de Meter, 12.3.2. Mapeamento dos 11 Canais de Medição (`CHANNEL` byte), 12.3. Endereçamento e Polling dos Meters (IN/OUT L/R e Gain Reduction GR L/M/H), 12. Mapeamento de Algoritmo: Multiband Compressor (M.BAND DYNA.)
...
### Community 2694 - "doc-question-mark"
Cohesion: 0.50
...
Cohesion: 0.10
Nodes (19): api-newtype-safety, Bad, Constructor Patterns, Derive Common Traits, Good, See Also, When Newtypes Help Most, Why It Matters (+11 more)
...
### Community 2934 - "lint-workspace-lints"
Cohesion: 0.25
Nodes (8): Bad, Blanket From Implementations, err-from-impl, From with Context, Good, See Also, Use thiserror for Automatic From, Why It Matters
...
Cohesion: 0.08
Nodes (37): AnalysisInfo, CeltMode, Default, Option, RangeCoder, Self, Vec, alloc_trim_analysis() (+29 more)

### Community 9109 - "RangeCoder"
Cohesion: 0.11
Nodes (40): Option, RangeCoder, alg_quant_qext(), alg_quant_resynth_avx2(), alg_quant_resynth_neon(), alg_quant_resynth_scalar(), alg_unquant(), celt_pvq_u() (+32 more)
...
Cohesion: 0.09
Nodes (30): Default, RangeCoder, SilkDecoderState, SilkDecoderControl, SilkDecoderState, RangeCoder, SilkDecoderState, RangeCoder (+22 more)

### Community 9125 - "SilkDecoderControl"
Cohesion: 0.08
Nodes (35): SilkDecoderControl, SilkDecoderState, SilkEncoderStateCommon, NLSFCodebook, NLSFCodebook, SilkEncoderControl, SilkEncoderState, NLSFCodebook (+27 more)

### Community 9149 - "SilkEncoderControl"
Cohesion: 0.11
Nodes (38): SilkEncoderControl, SilkEncoderState, silk_biquad_alt_stride1(), silk_biquad_alt_stride2(), silk_add_sat16(), silk_add_sat32(), silk_rshift(), silk_rshift_round() (+30 more)

## Knowledge Gaps
- **14639 isolated node(s):** `contentHash`, `downloadedAt`, `contentHash`, `downloadedAt`, `contentHash` (+14634 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **3146 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `OpusEncoder` connect `Community 633` to `Community 165`, `Community 651`, `Community 1039`, `Community 1457`, `Community 662`, `Community 1590`?**
...
- **What connects `contentHash`, `downloadedAt`, `contentHash` to the rest of the system?**
  _14694 weakly-connected nodes found - possible documentation gaps or missing edges._
