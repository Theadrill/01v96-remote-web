...
## Corpus Check
- 508 files · ~440,497 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7188 nodes · 7654 edges · 575 communities (518 shown, 57 thin omitted)
- Extraction: 98% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 114 edges (avg confidence: 0.83)
...
Cohesion: 0.15
Nodes (28): calibrateStep() - meter step to fill percent, dbToRaw() - dB to fader value conversion, enableDragScroll() - drag-to-scroll utility, enterMusicianMode() - activates musician view, faderInput() - commits fader change, initUI() - rebuilds all channel strips, rawToDb() - fader value to dB conversion, toggleState() - toggles On/Solo via socket (+20 more)
...
Cohesion: 0.12
Nodes (18): eqBands, freqToRaw(), gainToRaw(), initEQEngine(), nudgeQ(), onEQMove(), rawToFreq(), rawToGain() (+10 more)
...
Cohesion: 0.11
Nodes (50): delete_preset(), delete_slots(), enqueue_git_sync(), get_hosts(), get_mod_config(), get_names(), get_slots(), GitSyncState (+42 more)
...
Cohesion: 0.09
Nodes (28): EQ ATT Attenuator Control, flatEQ Reset All Bands to Flat, nudgeATT(), nudgeFreq(), nudgeGain(), toggleEQ(), getChannelParamPrefix(), eqBands (+20 more)
...
Cohesion: 0.09
Nodes (25): app, atualizarMenuTray(), configFile, dummy, dynamicsQueue, executarConexao(), express, fs (+17 more)
...
Cohesion: 0.15
Nodes (17): renderAuxs Aux Sends UI Renderer, createDesktopStrip / createMobileStrip Universal Fader Components, EQ Canvas Graph Renderer (60fps Animation), EQ Copy/Paste Clipboard Buffer, EQ Engine (WebAudio BiquadFilter 4-Band), renderEQ Full EQ UI Renderer, setBandMode (HPF/LPF/Shelf/Peaking Toggle), Desktop Grab-to-Scroll (Faders Area Drag) (+9 more)
...
Cohesion: 0.17
Nodes (10): showSceneGrid Scene Save/Load Grid Modal, fuzzyMatch(), normalizeStr(), resetDmx(), setLayoutMode Mobile/Desktop Toggle, Connection State Handler (Online/Offline/Demo), Ports List Handler (MIDI Config), Scene Update Handlers (scenesUpdated/currentScene) (+2 more)
...
Cohesion: 0.47
Nodes (6): mapDynDbToPercent() - dynamics dB to UI percent, renderCompressor() - renders compressor UI, renderDynamics() - container for gate+compressor, renderGate() - renders gate UI panel, appReady flag - UI sync gate, routing.js - Patch/bus/stereo routing UI

### Community 573 - "Community 573"
Cohesion: 0.33
Nodes (6): rawToFreq() - EQ index to Hz, renderAuxs() - renders AUX sends modal, renderEQ() - renders EQ canvas + controls, renderRouting() - renders channel routing UI, switchTab() - switches channel config tab, sysexToVal() - decode 10-bit SysEx bytes
...
## Knowledge Gaps
- **5416 isolated node(s):** `contentHash`, `downloadedAt`, `contentHash`, `downloadedAt`, `contentHash` (+5411 more)
...
- **Why does `socket.js - Socket.IO event listeners and meter rendering` connect `Web Frontend Utility Functions` to `Mixer UI Client Modules (channel strip, EQ, gate, aux, routing)`, `Community 572`, `Community 573`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
